...
#define LATCH_BUTTON 12 //Pin 12 for inputting switch signal.
int lockButton = HIGH;
...
void setup() {
  ...
  pinMode(LATCH_BUTTON, INPUT); //pin12
...
void loop() {
  ...
  while (client.available()) {
    client.poll();
    /*
    if (millis() - interval > door_opened_millis) { // current time - face recognised time > X secs
