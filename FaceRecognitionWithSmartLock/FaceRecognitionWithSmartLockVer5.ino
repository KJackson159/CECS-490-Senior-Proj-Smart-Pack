...
void loop() {
  ...
  Serial.println(digitalRead(LATCH_BUTTON));
        ...
        if (align_face(out_res.net_boxes, image_matrix, aligned_face) == ESP_OK)
        {
          ...
          if (g_state == START_RECOGNITION  && (st_face_list.count > 0))
          {
            ...
            { /*NOTE: This part will be changed to simply return to our future web code for demo 3 of our main website w/ menu, including the follow-me feature.
              ...
              //When LATCHLOCK is HIGH, secure lock is off.
              //if (digitalRead(LATCHLOCK) == LOW){
              //  digitalWrite(LATCHLOCK, HIGH);
              ...
              while((lockButton == LOW) && (currWaitTime < startWaitTime)){ //While button has not been pressed yet nor have timed out, wait for user to press button.
                ...
                Serial.print("LockButton = "); //Debugging
            ...
            else{ //Else, do nothing, and it will try again.
